...
import { printComments } from "../lib/views/wall.js";
...
export const readDataPost = async() => {
        ...
        const arrVoid = [];
        querySnapshot.forEach(doc => arrVoid.push(Object.assign(doc.data(), { "id": doc.id })))
    ...
    /*export const readDataPost = () => {
        ...
        onSnapshot(q, (querySnapshot) => {
            //onSnapshot escucha los elementos del documento
            querySnapshot.forEach((doc) => {
                //QuerySnapshot accede a los objetos que llama de doc por medio del array
